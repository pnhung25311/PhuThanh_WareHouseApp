...
class SmartDropdown<T> extends StatefulWidget {
  ...
  /// 🆕 Giới hạn chiều cao tối đa của dropdown (khi vượt thì scroll)
        ...
        if (_selected.contains(item)) {
          ...
          if (widget.maxSelection != null &&
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content:
                    Text("Chỉ được chọn tối đa ${widget.maxSelection} mục"),
              ),
            );
            return;
          }
      ...
      children: [
        ...
        Opacity(
          ...
          child: AbsorbPointer(
            ...
            child: Card(
              color:
                  widget.readOnly ? Colors.grey.shade100 : Colors.white,
                    ...
                    child: Row(
                      ...
                      children: [
                        TextButton.icon(
                          ...
                          onPressed:
                              isInteractive ? widget.functionCreate : null,
                        ),
                        TextButton.icon(
