  ...
  Future<void> _handleLogin(String username, String password) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Bắt buộc đổi mật khẩu nếu tài khoản vẫn đang dùng mật khẩu mặc định
        if (account.PassWord == kDefaultPassword) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text(
                'Mật khẩu của bạn đang là mật khẩu mặc định. Vui lòng đổi mật khẩu để tiếp tục.',
              ),
              backgroundColor: Colors.orange,
            ),
          );
          navigationHelper.pushAndRemoveUntil(
            ...
            ChangePasswordScreen(
              ...
              forceChange: true,
              targetSystemId: _selectedSystem!.id,
            ),
          );
          return;
        }
