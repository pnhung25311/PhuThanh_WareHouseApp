...
import 'package:phuthanh_warehouseapp/warehouse/screen/sheetcheck/HomeCheckListScreen.screen.dart';
...
import 'package:phuthanh_warehouseapp/warehouse/components/utils/CustomWarehouseLongClick.custom.dart';
...
class _WareHouseScreenState extends State<WareHouseScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveDrawerScaffold(
      ...
      onWarehouseSelected: _onDrawerReload,
