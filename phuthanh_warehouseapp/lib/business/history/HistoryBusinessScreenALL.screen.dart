...
class HistoryBusinessScreenALL extends StatefulWidget {
  final isExIm;
  const HistoryBusinessScreenALL({super.key, this.isExIm});

  @override
  State<HistoryBusinessScreenALL> createState() =>
      _HistoryBusinessScreenALLScreenState();
}

class _HistoryBusinessScreenALLScreenState
    extends State<HistoryBusinessScreenALL> {
  ...
  Future<void> _loadHistory() async {
    ...
    try {
      final data;
      if (widget.isExIm) {
        data = await businessservice.getAllHistory("ct90");
      } else {
        data = await businessservice.getAllHistory("ct70y");
      }
        ...
        title: AnimatedSwitcher(
          ...
          child: _isSearching
              ...
              : Text(
                  ...
                  style: TextStyle(
                    fontSize: 18,
                    color: const Color.fromARGB(255, 58, 240, 3),
                  ),
                ),
        ),
        actions: [
